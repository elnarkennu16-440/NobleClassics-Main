      ...
      if (mysqli_num_rows($select_msgs) > 0) {
        while ($fetch_msgs = mysqli_fetch_assoc($select_msgs)) {
          ...
          <div class="admin_box" style="background:#3f093a; border-radius: 30px; height: 400px; margin-top: 20px;">
            <p style="color:aliceblue; margin-bottom: 20px;">Name : <span
                style="color:blanchedalmond"><?php echo $fetch_msgs['name']; ?></span></p>
            <p style="color:aliceblue; margin-bottom: 20px;">Number : <span
                style="color:blanchedalmond"><?php echo $fetch_msgs['number']; ?></span></p>
            <p style="color:aliceblue; margin-bottom: 20px;">Email : <span
                style="color:blanchedalmond"><?php echo $fetch_msgs['email']; ?></span></p>
            <p style="color:aliceblue; margin-bottom: 20px;">Message : <span
                style="color:blanchedalmond"><?php echo $fetch_msgs['message']; ?></span></p>
            <a href="Admin_Messages.php?delete=<?php echo $fetch_msgs['id']; ?>"
              onclick="return confirm('Are you sure you want to delete this message?');" class="delete-btn"
              style="background:#62318d; border-radius: 10px; margin-top: 140px;"
              onmouseover="this.style.background='#3b1a73';" onmouseout="this.style.background='#62318d';">Delete
              Message</a>
          </div>
          <?php
        }
