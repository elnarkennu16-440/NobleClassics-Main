...
<head>
  ...
  <style>
    .pro_box {
      ...
      align-items: center;
      text-align: center;
      width: 250px; /* Width of the product box */
      margin: 20px;
    ...
    .book-rating {
      display: flex;
      justify-content: center; /* Align stars horizontally */
      align-items: center;
      margin-top: 10px;
    }
...
<div class="shop_heading" style="display: flex; align-items: center; justify-content: center; gap: 1rem; flex-flow: column; min-height: 15rem; padding: 2rem; animation: backgroundAnimation 5s infinite;">
  ...
  <div class="pro_box_cont">
    ...
    ?>
      <form action="" method="post" class="pro_box">
        <a href="#" class="book-link" data-title="<?php echo $fetch_products['name']; ?>" data-price="<?php echo $fetch_products['price']; ?>" data-img="./Book_Images/<?php echo $fetch_products['image']; ?>">
...
<div id="bookDetailsModal" style="display:none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.7); color: #fff; padding: 20px; z-index: 999;">
  <div style="max-width: 900px; margin: auto; background: #2b1b03; padding: 20px; border-radius: 10px; overflow: auto; max-height: 90vh;">
    <span id="closeModal" style="color: #fff; font-size: 30px; cursor: pointer; position: absolute; top: 20px; right: 20px;">&times;</span>
    <div style="display: flex; flex-wrap: wrap; gap: 20px;">
      <img id="bookImage" src="" alt="" style="max-width: 300px; max-height: 400px; object-fit: contain; border-radius: 10px; border: 2px solid #fff;">
      <div style="flex: 1; min-width: 250px;">
        <h3 id="bookTitle" style="font-size: 28px; color: #fff; margin-bottom: 10px;"></h3>
        <!-- Removed the bookRating (Star Rating) section -->
        <p id="bookDescription" style="font-size: 16px; line-height: 1.6; margin-bottom: 20px; text-align: justify;"></p>
...
<style>
 .pro_box {
  ...
  transform: translateX(100%); /* Start position for slide-in effect */
...
@media (max-width: 768px) {
  .pro_box {
    ...
    margin: 10px;
    transform: none !important; /* Disable sliding effect */
    opacity: 1 !important; /* Keep the boxes fully visible without animation */
    transition: none; /* Remove transition for smooth effect */
  }
}
...
.pro_box:hover .product_btn {
  background-color: #a47224; /* Change color when hovering over the box */
}
